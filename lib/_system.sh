...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Baixando o código do WhatsCRM...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos a actualizar el sistema WhatsCRM...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos a eliminar el WhatsCRM...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a bloquear el WhatsCRM...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a Desbloquear el WhatsCRM...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos a Cambiar los Dominios del WhatsCRM...${GRAY_LIGHT}"
  printf "\n\n"
